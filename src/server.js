...
async function seedDatabase() {
  try {
    ...
    if (productCount === 0) {
      const products = [
        // Phones
        { name: "iPhone 13 Pro Max", category: "phones", price: 450000, image: "images/iphone_113-removebg-preview.png", desc: "256GB, A15 chip, triple camera", stock: 10 },
        { name: "iPhone 13 Pro", category: "phones", price: 400000, image: "images/iphone_113-removebg-preview.png", desc: "256GB, A15 chip, triple camera", stock: 10 },
        { name: "iPhone 13", category: "phones", price: 350000, image: "images/iphone_113-removebg-preview.png", desc: "128GB, A15 chip, dual camera", stock: 10 },
        { name: "iPhone 12 Pro Max", category: "phones", price: 320000, image: "images/iphone_113-removebg-preview.png", desc: "128GB, A14 chip", stock: 10 },
        { name: "iPhone 12", category: "phones", price: 280000, image: "images/iphone_113-removebg-preview.png", desc: "128GB, A14 chip, dual camera", stock: 10 },
        { name: "iPhone 11", category: "phones", price: 220000, image: "images/iphone_113-removebg-preview.png", desc: "64GB, A13 chip, triple camera", stock: 10 },
        { name: "iPhone XS Max", category: "phones", price: 180000, image: "images/xs.png", desc: "64GB, A12 chip, dual camera", stock: 10 },
        { name: "iPhone XR", category: "phones", price: 150000, image: "images/xs.png", desc: "64GB, A12 chip, single camera", stock: 10 },
        // Laptops
        { name: "MacBook Pro 14 inch", category: "laptops", price: 850000, image: "images/hero img.png", desc: "M1 Pro, 16GB RAM, 512GB SSD", stock: 5 },
        { name: "MacBook Air M2", category: "laptops", price: 650000, image: "images/hero img.png", desc: "M2 chip, 8GB RAM, 256GB SSD", stock: 5 },
        { name: "Dell XPS 13", category: "laptops", price: 550000, image: "images/hero img.png", desc: "Intel i7, 16GB RAM, 512GB SSD", stock: 5 },
        { name: "HP Spectre x360", category: "laptops", price: 480000, image: "images/hero img.png", desc: "Intel i7, 16GB RAM, 512GB SSD, 2-in-1", stock: 5 },
        { name: "Lenovo ThinkPad X1", category: "laptops", price: 520000, image: "images/hero img.png", desc: "Intel i7, 16GB RAM, 512GB SSD", stock: 5 },
        // Tablets
        { name: "iPad Pro 12.9 inch", category: "tablets", price: 550000, image: "images/hero img.png", desc: "M1 chip, 128GB, WiFi", stock: 8 },
        { name: "iPad Air", category: "tablets", price: 350000, image: "images/hero img.png", desc: "M1 chip, 64GB, WiFi", stock: 8 },
        { name: "iPad 10th Gen", category: "tablets", price: 250000, image: "images/hero img.png", desc: "A14 chip, 64GB, WiFi", stock: 8 },
        { name: "Samsung Galaxy Tab S8", category: "tablets", price: 380000, image: "images/hero img.png", desc: "Snapdragon 8 Gen 1, 128GB", stock: 8 },
        // Accessories
        { name: "AirPods Pro", category: "accessories", price: 120000, image: "images/Airpods-removebg-preview.png", desc: "Active noise cancellation", stock: 20 },
        { name: "AirPods 3", category: "accessories", price: 85000, image: "images/Airpods-removebg-preview.png", desc: "Spatial audio, wireless charging", stock: 20 },
        { name: "iPhone Charger 20W", category: "accessories", price: 15000, image: "images/xs.png", desc: "Fast charging adapter", stock: 30 },
        { name: "USB-C Cable", category: "accessories", price: 5000, image: "images/xs.png", desc: "1m braided cable", stock: 30 },
        { name: "Phone Case iPhone 13", category: "accessories", price: 8000, image: "images/xs.png", desc: "Silicone case, various colors", stock: 25 },
        { name: "Power Bank 20000mAh", category: "accessories", price: 25000, image: "images/xs.png", desc: "Fast charging, dual USB", stock: 15 },
        { name: "Screen Protector", category: "accessories", price: 3000, image: "images/xs.png", desc: "Tempered glass, pack of 2", stock: 50 }
      ];
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://ftswypapxmvqemxwwclj.supabase.co", "wss://*.supabase.co", "https://*.supabase.co"],
    },
  },
}));
...
// Use ?force=true to re-seed even if products exist
app.get("/api/seed-products", async (req, res) => {
  try {
    const force = req.query.force === 'true';
    const productCount = await Product.countDocuments();
    
    // Seed products - either when empty or when force=true
    if (productCount === 0 || force) {
        ...
        // Use the same products as the main shop (from js/products.js)
        ...
        return res.json({
            success: true,
            message: force ? "Products re-seeded successfully" : "Products seeded successfully",
